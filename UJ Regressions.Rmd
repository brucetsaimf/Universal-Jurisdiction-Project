...
replication_model_casedefending = lm(defending.casecount ~ lwbstocksout_full + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(replication_model_caseprosecuting)
summary(replication_model_casedefending)
...
replication_model_trialdefending = lm(defending.trialcount ~ lwbstocksout_full + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(replication_model_trialprosecuting)
summary(replication_model_trialdefending)
```
...
leblang_model_casedefending = lm(defending.casecount ~ newflow + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(leblang_model_caseprosecuting)
summary(leblang_model_casedefending)
...
leblang_model_trialdefending = lm(defending.trialcount ~ newflow + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(leblang_model_trialprosecuting)
summary(leblang_model_trialdefending)
```
...
refugee_model_casedefending = lm(defending.casecount ~ y + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(refugee_model_caseprosecuting)
summary(refugee_model_casedefending)
...
refugee_model_trialdefending = lm(defending.trialcount ~ y + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(refugee_model_trialprosecuting)
summary(refugee_model_trialdefending)
```
...
demigcob_model_casedefending = lm(defending.casecount ~ COB.Flow + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(demigcob_model_caseprosecuting)
summary(demigcob_model_casedefending)
...
demigcob_model_trialdefending = lm(defending.trialcount ~ COB.Flow + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(demigcob_model_trialprosecuting)
summary(demigcob_model_trialdefending)
```
...
demigcor_model_casedefending = lm(defending.casecount ~ COR.Flow + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(demigcor_model_caseprosecuting)
summary(demigcor_model_casedefending)
```
...
demigcor_model_trialdefending = lm(defending.trialcount ~ COR.Flow + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(demigcor_model_trialprosecuting)
summary(demigcor_model_trialdefending)
```
...
demigcoc_model_casedefending = lm(defending.casecount ~ COC.Flow + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(demigcoc_model_caseprosecuting)
summary(demigcoc_model_casedefending)
```
...
demigcoc_model_trialdefending = lm(defending.trialcount ~ COC.Flow + polity_s_1 + polity_s_2 + violence_domestic_2 +
                         lpop_1 + lpop_2 + lgdpcap_1 + lgdpcap_2 + imports1000 + exports1000 + factor(alliance) + ldist2 + 
                         factor(d_colony2) + factor(langshare) + year + factor(romesigned) + factor(romeratify), data = merged_data) # missing shared border

summary(demigcoc_model_trialprosecuting)
summary(demigcoc_model_trialdefending)
```
...
```{r}
# Replication Cases
export_summs(replication_model_caseprosecuting, replication_model_casedefending, model.names = c("Replication Data Prosecuting Cases", "Replication Data Defending Cases"), scale = TRUE)
